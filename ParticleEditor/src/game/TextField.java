...
public class TextField {
	...
	TextField(String aLable, int aX, int aY, int aWidth, String aInitialValue, GameContainer aContainer) {
		myX = aX;
		myY = aY;
		...
		myTextField = new org.newdawn.slick.gui.TextField(aContainer, myFont, myX, myY + headingOffset, aWidth, 20);
