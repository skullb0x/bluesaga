...
public class StreakContainer {
  ...
  public void GetStreakTypeFromDB(StreakType aStreakType, ResultSet aStreakResult)
    ...
    aStreakType.myStartColor =
        new Color(
            Integer.parseInt(startColorRGBA[0]),
            Integer.parseInt(startColorRGBA[1]),
            Integer.parseInt(startColorRGBA[2]),
            Integer.parseInt(startColorRGBA[3]));
    String[] endColorRGBA = aStreakResult.getString("EndColor").split(",");
    aStreakType.myEndColor =
        new Color(
            Integer.parseInt(endColorRGBA[0]),
            Integer.parseInt(endColorRGBA[1]),
            Integer.parseInt(endColorRGBA[2]),
            Integer.parseInt(endColorRGBA[3]));
  }
