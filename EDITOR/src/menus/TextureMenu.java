...
public class TextureMenu {
	...
	public void load(){
		...
		Buttons.add(new TextureButton(X+(i%8)*50,(int) (Y+Math.floor(i/8)*50), "Back", ""));
		i++;
		
		
		Buttons.add(new TextureButton(X+(i%8)*50,(int) (Y+Math.floor(i/8)*50), "Delete", ""));
		i++;
				...
				*/	
						if(ext.equals("png")){
							if(!name.contains("_1") && !name.contains("_2")){
								Buttons.add(new TextureButton(X+(i%8)*50,(int) (Y+Math.floor(i/8)*50), name, ActivePath+file.getName()));
								i++;
							}
						}
				...
				Buttons.add(new TextureButton(X+(i%8)*50, (int) (Y+Math.floor(i/8)*50), file.getName(),"Directory"));
				i++;
			}
		}
