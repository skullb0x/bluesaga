...
public class LanguageUtils {
	...
	public static LinkedHashMap<String,String> languageResource = new LinkedHashMap<String,String>();
	public static LinkedHashMap<String,String> originalResource = new LinkedHashMap<String,String>();
    ...
    public static String getString(String key){
    	if(languageResource.get(key) == null || languageResource.get(key).equals("") || languageResource.get(key) == null){
