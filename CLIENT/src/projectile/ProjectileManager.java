	...
	public void draw(){
		...
		for(int i = 0; i < Projectiles.size(); i++){
			...
			if(!Projectiles.get(i).getActive()){
				...
				int renderProjX = Math.round(projX * ClientSettings.TILE_SIZE + ScreenHandler.myCamera.getX() + projMoveX - 25);
				int renderProjY = Math.round(projY * ClientSettings.TILE_SIZE + ScreenHandler.myCamera.getY() - projMoveY - 25);
