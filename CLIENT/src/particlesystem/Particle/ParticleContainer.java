...
public class ParticleContainer {
	...
	public void GetParticleTypeFromDB( ParticleType aParticleType, ResultSet aParticleResult) throws SQLException {
		...
		aParticleType.myStartColor = new Color(Integer.parseInt(startColorRGB[0]),Integer.parseInt(startColorRGB[1]),Integer.parseInt(startColorRGB[2]),255);
		String[] endColorRGB = aParticleResult.getString("EndColor").split(",");
		aParticleType.myEndColor = new Color(Integer.parseInt(endColorRGB[0]),Integer.parseInt(endColorRGB[1]),Integer.parseInt(endColorRGB[2]),255);
