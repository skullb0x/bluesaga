    ...
    if (isActive()) {
      ...
      if (getTimeItr() < 50) {
        ...
        for (Integer card : cards) {
          ...
          ImageResource.getSprite("items/item" + card)
              .draw(cardX, cardY, new Color(255, 255, 255, cardFade));
      ...
      if (getTimeItr() > 50 && getTimeItr() < 1100) {
        ...
        String text =
            player.getName() + " " + LanguageUtils.getString("movies.cards.collect_cards");
