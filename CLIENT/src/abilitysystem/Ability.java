...
public class Ability {
  ...
  public void load(String abilityInfo) {
    ...
    if (classId > 0) {
      ...
      bgColor =
          new Color(
              Integer.parseInt(bgColorInfo[0]),
              Integer.parseInt(bgColorInfo[1]),
              Integer.parseInt(bgColorInfo[2]));
    }

    abilityColor =
        new Color(Integer.parseInt(info[3]), Integer.parseInt(info[4]), Integer.parseInt(info[5]));
  ...
  */
  ...
  public int getCooldownHeight(int max) {
    ...
    if (Cooldown > 0) {
      cooldownHeight =
          Math.round(((float) (Cooldown * 5 - CooldownLeft) / (float) (Cooldown * 5)) * max);
    }
