...
public class RoundAttackAnimation extends CreatureAnimation {
	...
	public RoundAttackAnimation(float rotation, float speed) {
		...
		while(rotation >= 0.0f){
			...
			animationChannels.get(0).add(new TranslateXAnimation(this,oldX,changeX,partDuration,"Linear"));
			animationChannels.get(1).add(new TranslateYAnimation(this,oldY,changeY,partDuration,"Linear"));
		...
		animationChannels.get(0).add(new TranslateXAnimation(this,oldX,-oldX,partDuration,"Linear"));
		animationChannels.get(1).add(new TranslateYAnimation(this,oldY,-oldY,partDuration,"Linear"));
		totalDuration += partDuration;
