...
public class RollAttackAnimation extends CreatureAnimation {
  ...
  public RollAttackAnimation(int dX, int dY, float speed) {
    ...
    animationChannels
        .get(1)
        .add(new TranslateYAnimation(this, 0.0f, -20.0f, 20.0f * speed, "None"));
    animationChannels
        .get(1)
        .add(new TranslateYAnimation(this, -20.0f, 20.0f, 20.0f * speed, "None"));

    // X
    animationChannels
        .get(0)
        .add(new TranslateXAnimation(this, 0.0f, 40.0f * dX, 20.0f * speed, "None"));
    animationChannels
        .get(0)
        .add(new TranslateXAnimation(this, 40.0f * dX, -40.0f * dX, 30.0f * speed, "Quad"));

    // Y
    animationChannels
        .get(1)
        .add(new TranslateYAnimation(this, 0.0f, 40.0f * dY, 20.0f * speed, "None"));
    animationChannels
        .get(1)
        .add(new TranslateYAnimation(this, 40.0f * dY, -40.0f * dY, 30.0f * speed, "Quad"));
