...
public class ItemHandler extends Handler {
	...
	public static void handleData(String serverData){
		...
		if(serverData.startsWith("<you_equip>")){
			...
			ScreenHandler.myEmitterManager.SpawnEmitter(BlueSaga.playerCharacter.getPixelX()+25, -BlueSaga.playerCharacter.getPixelY(), "Equip");
		...
		if(serverData.startsWith("<item_info>")){
			...
			}else if(info[0].equals("container") || info[0].equals("personalchest") || info[0].equals("closet")){
		...
		if(serverData.equals("<useitem>no")){
			...
			if(USER.getCreatureType() == CreatureType.Player && USER.getDBId() == BlueSaga.playerCharacter.getDBId()){
