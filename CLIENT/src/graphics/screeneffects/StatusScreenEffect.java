  ...
  public void draw(Graphics g) {
    ...
    if (duration_itr > duration) {
      ...
      if (Name.equals("Hit")) {
        ...
        spiralAngle += 0.05f;
        ImageResource.getSprite("effects/screenfx_spiral")
            .getImage()
            .draw(0, 0, ClientSettings.SCREEN_WIDTH, ClientSettings.SCREEN_HEIGHT);
      }
    }
  }
  ...
  public void setEffectColor(Color newColor) {
    ...
    topG =
        new GradientFill(
            0,
            0,
            new Color(newColor.getRed(), newColor.getGreen(), newColor.getBlue(), 255),
            0,
            gSize / 2,
            new Color(newColor.getRed(), newColor.getGreen(), newColor.getBlue(), 0));
    bottomG =
        new GradientFill(
            0,
            ClientSettings.SCREEN_HEIGHT - gSize / 2,
            new Color(newColor.getRed(), newColor.getGreen(), newColor.getBlue(), 0),
            0,
            ClientSettings.SCREEN_HEIGHT,
            new Color(newColor.getRed(), newColor.getGreen(), newColor.getBlue(), 255));
    ...
    bottomR =
        new Rectangle(
            0, ClientSettings.SCREEN_HEIGHT - gSize / 2, ClientSettings.SCREEN_WIDTH, gSize);
    // LEFT
