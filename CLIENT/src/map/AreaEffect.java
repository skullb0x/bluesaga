		...
		if(AreaNameAlpha > 0){
			...
			*/
			...
			if(guardLevel == 0){
				...
				g.fillRoundRect(512 - Font.size18.getWidth(LanguageUtils.getString("ui.area_effect.unguarded_zone"))/2 - 13, zoneStatusY-4, Font.size18.getWidth(LanguageUtils.getString("ui.area_effect.unguarded_zone")) + 26, 38, 5);
				g.setColor(new Color(238,76,76,AreaNameAlpha));
				g.fillRoundRect(512 - Font.size18.getWidth(LanguageUtils.getString("ui.area_effect.unguarded_zone"))/2 - 9, zoneStatusY, Font.size18.getWidth(LanguageUtils.getString("ui.area_effect.unguarded_zone")) + 18, 30, 5);
			
				g.setColor(new Color(22,22,22,AreaNameAlpha));
				g.drawString(LanguageUtils.getString("ui.area_effect.unguarded_zone"), 512 - Font.size18.getWidth(LanguageUtils.getString("ui.area_effect.unguarded_zone"))/2, zoneStatusY+5);
				ImageResource.getSprite("gui/skulls/silver").getImage().draw(512 - Font.size18.getWidth(LanguageUtils.getString("ui.area_effect.unguarded_zone"))/2 - 40, zoneStatusY-5,40, 40, new Color(255,255,255,AreaNameAlpha));
				ImageResource.getSprite("gui/skulls/silver").getImage().draw(512 + Font.size18.getWidth(LanguageUtils.getString("ui.area_effect.unguarded_zone"))/2, zoneStatusY-5,40, 40, new Color(255,255,255,AreaNameAlpha));
			}else{
				g.setColor(new Color(0,0,0,AreaNameAlpha-170));
				g.fillRoundRect(512 - Font.size18.getWidth(LanguageUtils.getString("ui.area_effect.safe_zone"))/2 - 13, zoneStatusY-4, Font.size18.getWidth(LanguageUtils.getString("ui.area_effect.safe_zone")) + 26, 38, 5);
				g.setColor(new Color(196,233,125,AreaNameAlpha));
				g.fillRoundRect(512 - Font.size18.getWidth(LanguageUtils.getString("ui.area_effect.safe_zone"))/2 - 9, zoneStatusY, Font.size18.getWidth(LanguageUtils.getString("ui.area_effect.safe_zone")) + 18, 30, 5);
				g.setColor(new Color(22,22,22,AreaNameAlpha));
				g.drawString(LanguageUtils.getString("ui.area_effect.safe_zone"), 512 - Font.size18.getWidth(LanguageUtils.getString("ui.area_effect.safe_zone"))/2, zoneStatusY+5);
				ImageResource.getSprite("gui/skulls/silver").getImage().draw(512 - Font.size18.getWidth(LanguageUtils.getString("ui.area_effect.safe_zone"))/2 - 40, zoneStatusY-5,40, 40, new Color(255,255,255,AreaNameAlpha));
				ImageResource.getSprite("gui/skulls/silver").getImage().draw(512 + Font.size18.getWidth(LanguageUtils.getString("ui.area_effect.safe_zone"))/2, zoneStatusY-5,40, 40, new Color(255,255,255,AreaNameAlpha));
			}
