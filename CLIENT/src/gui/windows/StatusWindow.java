  ...
  public void draw(GameContainer app, Graphics g, int mouseX, int mouseY) {
    if (isVisible()) {
      ...
      if (isFullyOpened()) {
        ...
        g.drawString(
            " -  "
                + BlueSaga.playerCharacter.getName().toUpperCase()
                + " (lvl "
                + BlueSaga.playerCharacter.getLevel()
                + ")",
            textX + 150,
            textY + 2);
        ...
        */
        ...
        int xpLeft =
            Math.round(BlueSaga.playerCharacter.getNextXP() - BlueSaga.playerCharacter.getXP());
        ...
        g.drawString(
            (float) BlueSaga.playerCharacter.getTotalStat("CRITICAL_HIT") + " %",
            textX + 150,
            textY);
        ...
        g.drawString(
            ""
                ...
                + " ("
                + BlueSaga.playerCharacter.MyEquipHandler.getWeaponSpeed()
                + ")",
            textX + 100,
            textY);
        ...
        if (BlueSaga.playerCharacter.getBaseClass() != null) {
          baseClassColor =
              BlueSagaColors.getColorFromString(BlueSaga.playerCharacter.getBaseClass().bgColor);
          ;
          baseClassTextColor =
        ...
        if (BlueSaga.playerCharacter.getPrimaryClass() != null) {
          primaryClassColor =
              BlueSagaColors.getColorFromString(BlueSaga.playerCharacter.getPrimaryClass().bgColor);
          ;
          primaryClassTextColor =
              BlueSagaColors.getColorFromString(
                  BlueSaga.playerCharacter.getPrimaryClass().textColor);
          ;

          primaryLabel =
              BlueSaga.playerCharacter.getPrimaryClass().name
                  + " LVL "
                  + BlueSaga.playerCharacter.getPrimaryClass().level;
          primaryClassXpWidth =
              (int)
                  (((float) BlueSaga.playerCharacter.getPrimaryClass().getXp()
                          / (float) BlueSaga.playerCharacter.getPrimaryClass().nextXP)
                      * 160);
        }
        ...
        if (BlueSaga.playerCharacter.getSecondaryClass() != null) {
          secondaryClassColor =
              BlueSagaColors.getColorFromString(
                  BlueSaga.playerCharacter.getSecondaryClass().bgColor);
          secondaryClassTextColor =
              BlueSagaColors.getColorFromString(
                  BlueSaga.playerCharacter.getSecondaryClass().textColor);
          secondaryLabel =
              BlueSaga.playerCharacter.getSecondaryClass().name
                  + " LVL "
                  + BlueSaga.playerCharacter.getSecondaryClass().level;
          secondaryClassXpWidth =
              (int)
                  (((float) BlueSaga.playerCharacter.getSecondaryClass().getXp()
                          / (float) BlueSaga.playerCharacter.getSecondaryClass().nextXP)
                      * 160);
        }
        ...
        if (BlueSaga.playerCharacter.getTotalStat("ARMOR") > 999) {
          ...
          g.drawString(
              "" + (BlueSaga.playerCharacter.getTotalStat("ARMOR")), textX + 22, textY + 1);
        }
        ...
        g.drawString(
            "" + (BlueSaga.playerCharacter.getTotalStat("FIRE_DEF")), textX + 22, textY + 1);
        ...
        g.drawString(
            "" + (BlueSaga.playerCharacter.getTotalStat("COLD_DEF")), textX + 22, textY + 1);
        ...
        g.drawString(
            "" + (BlueSaga.playerCharacter.getTotalStat("SHOCK_DEF")), textX + 22, textY + 1);
        ...
        g.drawString(
            "" + (BlueSaga.playerCharacter.getTotalStat("CHEMS_DEF")), textX + 22, textY + 1);
        ...
        g.drawString(
            "" + (BlueSaga.playerCharacter.getTotalStat("MIND_DEF")), textX + 22, textY + 1);
        ...
        g.drawString(
            "" + (BlueSaga.playerCharacter.getTotalStat("MAGIC_DEF")), textX + 22, textY + 1);
        ...
        if (e.getValue().getItem() != null) {
          ...
          if (showInfo) {
            ...
            BlueSaga.client.sendMessage(
                "item_info", "equip;" + selectedItemForInfo.getUserItemId());
          }
        } else {
          selectedItemForInfo = null;
