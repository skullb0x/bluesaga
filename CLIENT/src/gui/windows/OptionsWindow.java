		...
		if(isVisible()){
			...
			*/
			...
			if(updatedSound){
				...
				BlueSaga.gameDB.updateDB("update option set GameValue = "+ClientSettings.soundVolume+" where GameOption = 'SfxVol'");
				BlueSaga.gameDB.updateDB("update option set GameValue = "+saveSFX_ON+" where GameOption = 'Sfx'");
			}
			...
			if(updatedMusic){
				...
				BlueSaga.gameDB.updateDB("update option set GameValue = "+ClientSettings.musicVolume+" where GameOption = 'MusicVol'");
				BlueSaga.gameDB.updateDB("update option set GameValue = "+saveMUSIC_ON+" where GameOption = 'Music'");
