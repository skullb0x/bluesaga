...
public class StartScreen {
	...
	public static void draw(){
		...
		ImageResource.getSprite("startscreen/bg_clouds2").getImage().getFlippedCopy(true, false).draw(Math.round(bgClouds2X+512),posY+390);
		ImageResource.getSprite("startscreen/bg_clouds2").draw(Math.round(bgClouds2X+1024),posY+390);
		ImageResource.getSprite("startscreen/bg_clouds2").getImage().getFlippedCopy(true, false).draw(Math.round(bgClouds2X+1536),posY+390);
		
		ImageResource.getSprite("startscreen/bg_clouds1").draw(Math.round(bgClouds1X),posY+405);
		ImageResource.getSprite("startscreen/bg_clouds1").getImage().getFlippedCopy(true, false).draw(Math.round(bgClouds1X+512),posY+405);
		ImageResource.getSprite("startscreen/bg_clouds1").draw(Math.round(bgClouds1X+1024),posY+405);
		ImageResource.getSprite("startscreen/bg_clouds1").getImage().getFlippedCopy(true, false).draw(Math.round(bgClouds1X+1536),posY+405);
		
		// mirror clouds
		ImageResource.getSprite("startscreen/bg_clouds1").getImage().getFlippedCopy(false, true).draw(bgClouds1X,posY+450, new Color(255,255,255,50));
		ImageResource.getSprite("startscreen/bg_clouds1").getImage().getFlippedCopy(true, true).draw(bgClouds1X+512,posY+450, new Color(255,255,255,50));
		ImageResource.getSprite("startscreen/bg_clouds1").getImage().getFlippedCopy(false, true).draw(bgClouds1X+1024,posY+450, new Color(255,255,255,50));
		ImageResource.getSprite("startscreen/bg_clouds1").getImage().getFlippedCopy(true, true).draw(bgClouds1X+1536,posY+450, new Color(255,255,255,50));
		...
		ImageResource.getSprite("startscreen/cloud1").getImage().draw((int) cloud1_x, (int) cloud1_mirror_y,140,-70, new Color(255,255,255,20));
		...
		ImageResource.getSprite("startscreen/cloud2").getImage().draw((int) cloud2_x, (int) cloud2_mirror_y ,155,-60, new Color(255,255,255,20));
