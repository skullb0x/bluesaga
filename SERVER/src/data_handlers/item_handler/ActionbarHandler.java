...
public class ActionbarHandler extends Handler {
	...
	public static void handleData(Client client, String message){
		...
		if(message.startsWith("<add_actionbar>")){
			String actionInfo[] = message.substring(15).split(";");
		...
		if(message.startsWith("<remove_actionbar>")){
			int pos = Integer.parseInt(message.substring(18));
