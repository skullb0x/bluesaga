...
public class CraftingHandler extends Handler {
	...
	public static void handleData(Client client, String serverData){
		...
		if(serverData.startsWith("<getrecipe>")){
			String craftingStationInfo = serverData.substring(11);
		...
		}else if(serverData.startsWith("<craftitem>")){
			String itemInfo = serverData.substring(11);
